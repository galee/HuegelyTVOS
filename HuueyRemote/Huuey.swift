...
public class Huuey {
    ...
    /**
     ...
     - Parameter: hue, Brightness of light 0 - 255
     - Parameter: light, HuueyLight
     */
    public func setHue(hue: Int, light: HuueyLight) {
        self.interface.setHue(hue, light: light)
    }
    ...
    public func setXY(light: HuueyLight) {
        self.interface.setXY(light)
    }
    
    public func setCT(light: HuueyLight) {
        self.interface.setCT(light)
    }

    public func setHSB(light: HuueyLight) {
        self.interface.setHSB(light)
    }
    
    public func sync(light: HuueyLight) {
        self.interface.sync(light)
    }
